...
void breadth_first_search(Graph& graph, Graph::Node*node,const uint8_t final_deep_level, uint8_t next_deep_level = 1, uint8_t actual_deep = 0) { //+ graph checking if graph contains node !max_deep >= deep
