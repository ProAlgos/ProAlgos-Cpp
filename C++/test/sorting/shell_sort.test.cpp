#define SHELL_SORT_TEST

#include <algorithm>
#include <functional>

#include "third_party/catch.hpp"
#include "source/sorting/shell_sort.cpp"

bool does_sort(vector<int>&& values, const int order = 1) {
    shell_sort(values, order);
