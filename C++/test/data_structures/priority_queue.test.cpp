...
TEST_CASE("Checking max() and remove() functions return the expected value", "[priority_queue]"){
    PriorityQueue pq;
    pq.insert(100);
    pq.insert(120);
    pq.insert(200);
...
TEST_CASE("Checking after inserting the same priorities we are getting expected value", "[priority_queue]"){
    PriorityQueue pq;
    pq.insert(12);
    pq.insert(20);
    pq.insert(12);
...
TEST_CASE("Checking whether max() and remove() return -1 if priority queue is empty", "[priority_queue]"){
    PriorityQueue pq;
